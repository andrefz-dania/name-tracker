...
<ButtonDecorated
  ...
  <div class="relative h-0 w-0">
    {#if open}
      <div
        class="absolute shadow-md bg-layer0 border border-primary min-w-64 top-8 -left-8 p-2 flex flex-col gap-2 rounded-md max-h-96"
      >
        ...
        <div class="flex flex-row gap-2 flex-wrap w-full p-2 overflow-y-scroll">
          {#each allTags as t}
            <button
              type="button"
              onclick={(e) => {
